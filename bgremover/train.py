...
def parse_args(args):
    ...
    parser.add_argument('--output_path', default='models/mymodel.h5')

    parser.add_argument('--path_to_raw', default='CamVid/train/')

    parser.add_argument('--image_size', default=(360, 480))

    parser.add_argument('--path_to_labels',default='CamVid/trainannot/')

    parser.add_argument('--path_to_labels_list', default='CamVid/train.txt')
